...
import '../Widgets/progress_indicating_button.dart';
...
class _SignUpWithPhoneNumberState extends State<SignUpWithPhoneNumber> {
  ...
  final String _tempTestPhoneNumber = '+11111111111';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('We will send a confirmation code to your phone'),
                        const SizedBox(
                          height: 20,
                        ),
                        Container(
  ...
  void _gotoVerificationScreen(String verificationId) {
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              PhoneNumberVerification(verificationId: verificationId,phoneNumber:  '+92' + _phoneNumber!,),
        ),
      );
    });
  }
